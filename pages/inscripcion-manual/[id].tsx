...
export default function ManualPage() {
  ...
  // 3️⃣ Cuando cambia birthDate, recalcular edad y catego.
  useEffect(() => {
  ...
  if (step==="expired") {
    return <TempAuthGuard><p className="p-6 text-center">Enlace expirado.</p></TempAuthGuard>;
  }
  if (step==="login") {
    return (
      <TempAuthGuard>
